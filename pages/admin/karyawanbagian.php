        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        <button type="submit" name="button_update" class="btn btn-success btn-block float-right mb-3"> <i class="fa fa-save"></i> Simpan</button>
                    </div>
                </form>
                ...
                <table id="myTable" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                <td><?php echo $no++ ?></td>
                                <td><?php echo $row_bagian['nama_bagian'] ?></td>
                                <td><?php echo $row_bagian['tanggal_mulai'] ?></td>
                                <td>
                                    <form action method="POST">
